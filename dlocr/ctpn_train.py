...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", help="迭代数", default=1, type=int)
    parser.add_argument("--gpus", help="gpu的数量", default=1, type=int)
    parser.add_argument("--images_dir", help="图像位置", default="../VOCdevkit/VOC2007/JPEGImages")
    parser.add_argument("--anno_dir", help="标注文件位置", default="../VOCdevkit/VOC2007/Annotations")
    ...
    if save_weigths_file_path is None:
        try:
            ...
            print("model path: ", save_weigths_file_path)
        except OSError:
