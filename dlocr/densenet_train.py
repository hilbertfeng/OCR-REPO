...
if __name__ == '__main__':
    ...
    parser.add_argument("--images_dir", help="图像位置", default="/home/vision/PycharmProjects/text-detection-ocr/images")
    parser.add_argument("--dict_file_path", help="字典文件位置",
                        default="/home/vision/PycharmProjects/text-detection-ocr/dlocr/dictionary/char_std_5990.txt")
    parser.add_argument("--train_file_path", help="训练文件位置",
                        default="/home/vision/PycharmProjects/text-detection-ocr/train.txt")
    parser.add_argument("--test_file_path", help="测试文件位置",
                        default="/home/vision/PycharmProjects/text-detection-ocr/test.txt")
